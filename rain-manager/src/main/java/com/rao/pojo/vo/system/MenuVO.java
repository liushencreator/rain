...
public class MenuVO {
     ...
     * @return
     */
    public static List<MenuVO> buildChildList(List<RainSystemMenu> systemMenuList, Long id) {
        ...
        for (RainSystemMenu systemMenu : systemMenuList) {
            if(systemMenu.getParentId().equals(id)){
                ...
                menuVO.setMenuVOList(buildChildList(systemMenuList, systemMenu.getId()));
