			...
			*/
			...
			if(this.ckplayerConfig['style']['logo']) {
				if(this.ckplayerConfig['style']['logo']['file']) {
					...
					if(logoFile.substr(0, 15) == 'data:images/png;' || logoFile.substr(0, 15) == 'data:images/jpg;' || logoFile.substr(0, 15) == 'data:images/jpeg;') {
		...
		*/
		screenshot: function(obj, save, name) {
			...
			if(obj == 'video') {
				...
				try {
					var base64 = newCanvas.toDataURL('images/jpeg');
